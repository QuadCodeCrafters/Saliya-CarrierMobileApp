...
class _DriverCurrentWorkState extends State<DriverCurrentWork> {
  ...
  SqfliteHelper helper = SqfliteHelper();
    List<dynamic> storeSaveRow = [];//store cancel data row (in the sql lite table)
     ...
     int testVar1 = 0; 
     Future errorUiSender2(BuildContext context,String message){
  return showDialog(
  ...
  return showDialog(
           barrierDismissible: false,
                ...
                notificationBody: 'Please tap here to open the app again.',
                        ...
                        child: const Text('Re-open the app'),
                      ),
                    ],
                  );
                }, 
    ...
    if(netStatus == "[ConnectivityResult.none]"){
     ...
     if(netStatus == "[ConnectivityResult.mobile]" || netStatus == "[ConnectivityResult.wifi]"){
      try{
        ...
        errorUiSender(context,"Error occured when connecting to database. Try again later");
      }
     }
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                                    gradient: LinearGradient(
                                      ...
                                      colors: [Color.fromARGB(255, 49, 90, 141), Color(0xFF1A365D)],
                                    ),
  ...
  children: [
    Icon(
      ...
      color: Colors.white70, // Set the icon color
...
SizedBox(height: 8),
      ...
      children: [
        Icon(
          Icons.phone, // Icon for "Customer Contact"
          color: Colors.white70,
          size: 16,
        ),
        SizedBox(width: 8), // Spacing between the icon and text
        Text(
          'Customer Contact: ${cusContactIndi[i]}',
          style: TextStyle(color: Colors.white70),
        ),
      ],
    ),
    ...
    Row(
      children: [
        Icon(
          Icons.credit_card, // Icon for "Customer NIC"
          color: Colors.white70,
          size: 16,
        ),
        SizedBox(width: 8),
        Text(
          'Customer NIC: ${nicIndi[i]}',
          style: TextStyle(color: Colors.white70),
        ),
      ],
    ),
    ...
    Row(
      children: [
        Icon(
          Icons.directions_car, // Icon for "Carrier Vehicle Number"
          color: Colors.white70,
          size: 16,
        ),
        SizedBox(width: 8),
                                ...
                                children: <Widget>[
                                  ElevatedButton(
                                            ...
                                            // print('Save test' + storeSaveRow.toString()); //for the test
                                             ...
                                             errorUiSender2(context,"Error occured when saving the event. Try again");
